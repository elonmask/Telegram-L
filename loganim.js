 ...
 if($div != undefined) {
  ...
  var gradients = [
  { start: [142,158,171], stop: [239,242,243] },
  { start: [230,218,218], stop: [142,158,171] },
  { start: [239,242,243], stop: [142,158,171] }
];
...
function updateGradient(){
  ...
  if (t_color1 != color1 || t_color2 != color2) {
    ...
    div_style.background = "-webkit-gradient(linear, left bottom, right top, from("+color1+"), to("+color2+"))";
    for (var i = 0; i < 4; i++) {
      div_style.background = prefixes[i]+"linear-gradient(45deg, "+color1+", "+color2+")";
    }
  }
